                            ...
                            <form method="POST" action="{{ route('jobs.update', $jobs->id) }}" id="job-form" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-sm-7">
                                        ...
                                        <textarea class="form-control block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" rows="5" id="desc" name="description" required >{{ $jobs->description }}</textarea>
