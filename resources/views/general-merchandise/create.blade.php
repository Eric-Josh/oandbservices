                            ...
                            <form method="POST" action="{{ route('gmerchandise.store') }}" id="gmerchandise-form" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control description block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" rows="5" id="desc" name="description" required ></textarea>
